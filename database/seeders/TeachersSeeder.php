...
final class TeachersSeeder extends Seeder
{
    public function run(): void
    {
        ...
        for ($i = 0; $i < 15; $i++) {
            ...
            do {
                $email = mb_strtolower($firstname).'.'.mb_strtolower($lastname).random_int(1000, 9999).'@example.com';
            ...
            $user = User::create([
                ...
                'telephone' => '+229'.random_int(90000000, 99999999),
                'photo_path' => null,
                'role_id' => 3,
                'is_active' => 1,
                ...
                'bio' => null,
                'qualifications' => null,
                'rate_per_hour' => random_int(1000, 5000),
            ...
            $randomSubjects = $allSubjects->random(random_int(1, 3))->pluck('id')->toArray();
