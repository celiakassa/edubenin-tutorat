...
<head>
    ...
    <style>
        ...
        .auth-split__brand-name { font-family: var(--kp-font-title); font-weight: 700; font-size: clamp(2.9rem, 1.8rem + 3.6vw, 4.6rem); margin: 0 0 16px; line-height: 1; letter-spacing: .3px; }
        .auth-split__brand-name span { color: var(--kp-yellow); }
        .auth-split__brand-text { font-size: 1.08rem; opacity: .92; max-width: 360px; line-height: 1.6; margin: 0; }
        ...
        @media (max-width: 991px) {
            ...
            .auth-split__logo { display: inline-block; }
            .auth-split__form { min-height: 100dvh; overflow: visible; padding: 34px 20px; border-radius: 0; margin-left: 0; }
        }
    </style>
    @stack('head')
</head>
...
<body>
    <div class="auth-split">
        ...
        <aside class="auth-split__brand">
            ...
            <div>
                <h1 class="auth-split__brand-name">Kop<span>iao</span></h1>
                <p class="auth-split__brand-text">@yield('brand_text', 'Rejoignez la communauté qui connecte apprenants et tuteurs partout au Bénin.')</p>
            </div>
        </aside>
    </div>
