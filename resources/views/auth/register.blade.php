...
@section('brand_text', 'Trouvez le tuteur parfait pour progresser. Créez votre compte apprenant en quelques secondes.')
...
@section('content')
    ...
    <h1 class="auth-form__title">Devenir apprenant</h1>
        ...
        <div class="row g-3">
            <div class="col-md-6 auth-group">
                ...
                <div class="auth-field-wrap">
                    ...
                    <input type="email" id="email" name="email" class="kp-field" value="{{ old('email') }}" required placeholder="exemple@email.com" style="padding-left: 42px;">
                </div>
                @error('email')<span class="auth-error">{{ $message }}</span>@enderror
            </div>
            <div class="col-md-6 auth-group">
                <label for="telephone">Téléphone <span class="opt">(opt.)</span></label>
                <div class="auth-field-wrap">
                    <i class="bi bi-telephone auth-field-ico"></i>
                    <input type="tel" id="telephone" name="telephone" class="kp-field" value="{{ old('telephone') }}" placeholder="+229 XX XX XX XX" style="padding-left: 42px;">
                </div>
        ...
        <div class="row g-3">
            <div class="col-md-6 auth-group">
                ...
                <div class="pw-wrap">
                    ...
                    <input type="password" id="password" name="password" class="kp-field" required placeholder="••••••••" style="padding-left: 42px; padding-right: 42px;">
            ...
            <div class="col-md-6 auth-group">
                ...
                <div class="pw-wrap">
                    ...
                    <input type="password" id="password_confirmation" name="password_confirmation" class="kp-field" required placeholder="••••••••" style="padding-left: 42px; padding-right: 42px;">
